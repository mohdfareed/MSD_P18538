...
ADHOC_PATH = "~/MSD_P18538/software/backend/app/services/network/adhoc-interface "
ROUTER_PATH = "~/MSD_P18538/software/backend/app/services/network/wifi-interface"
...
if __name__ == "__main__":
    ...
    mode_group.add_argument("-a", "--adhoc", action="store_true", help="Initialize the adhoc hosted network")
    mode_group.add_argument("-r", "--router", action="store_true", help="Initialize the router hosted network")
